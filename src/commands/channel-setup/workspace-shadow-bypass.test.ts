...
describe("resolveChannelSetupEntries workspace shadow exclusion", () => {
  ...
  it("keeps workspace-only install candidates visible until trusted", () => {
    const workspaceEntry = {
      id: "my-cool-plugin",
