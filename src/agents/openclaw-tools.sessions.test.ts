...
describe("sessions tools", () => {
  ...
  it("uses number (not integer) in tool schemas for Gemini compatibility", () => {
    ...
    expect(schemaProp("sessions_search", "maxResults").type).toBe("number");
    expect(schemaProp("sessions_search", "maxHitsPerSession").type).toBe("number");
    expect(schemaProp("sessions_search", "minScore").type).toBe("number");
    ...
    expect(schemaProp("sessions_spawn", "worktree").type).toBe("string");
