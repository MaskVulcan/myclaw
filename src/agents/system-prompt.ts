...
function buildSkillsSection(params: { skillsPrompt?: string; readToolName: string }) {
  ...
  return [
    ...
    "- If the chosen skill advertises capability ids, prefer `openclaw capabilities describe <id> --json` and `openclaw capabilities run <id> --input-json …` over improvising shell commands.",
