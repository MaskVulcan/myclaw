...
export type PluginRuntimeCore = {
  ...
  agent: {
    ...
    runAgentKernel: typeof import("../../agents/agent-kernel.js").runAgentKernel;
  ...
  modelAuth: {
    ...
    /**
     * Resolve request-ready auth for a model, including any provider-owned
     * runtime credential exchange scoped to the configured workspace.
     */
