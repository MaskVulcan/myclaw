...
> = {
  ...
  log?: Pick<ReturnType<typeof createSubsystemLogger>, "debug" | "error">;
...
>(
  ...
  const log = adapter.log ?? createSubsystemLogger(adapter.label);
    ...
    async start(): Promise<void> {
      ...
      startPromise = (async () => {
        ...
        const createGatewayClient =
          adapter.createGatewayClient ?? createOperatorApprovalsGatewayClient;
